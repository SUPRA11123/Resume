...
import { Github, Linkedin, Mail, Download, Quote, PenTool, ExternalLink } from "lucide-react";
...
// Optional: add real links when you have them
const THESIS_LINK = "https://drive.google.com/file/d/1JPdlajG-5PPOVeW2WBuHErLQKAy0Yd2R/view"; // e.g. "https://drive.google.com/your-thesis.pdf"
const LINKS = {
  // Awards / posts / press
  iqviaSilverAward: "https://drive.google.com/file/d/1hGztDkvSwgO16X5ZLBoS2DcFYHhZYQVR/view", // e.g. a LinkedIn post, blog, or PDF confirmation

  // Projects
  farmit: "https://www.github.com/SUPRA11123/farmit", // e.g. GitHub repo, demo video, or project page

  // References (you already show emails—adding mailto + optional profiles)
  refMoellerEmail: "mailto:michael.moeller@uni-siegen.de",
  refMoellerProfile: "#", // optional: group site or Google Scholar page
  refHerrmannEmail: "mailto:Stefan.Herrmann@csi-online.de",
  refHerrmannProfile: "https://drive.google.com/file/d/1D_zgo8iJUt1FvGAtP6rhhzjX5UYEdFES/view", // optional: company page or LinkedIn

  // Socials (already used)
  linkedIn: "https://www.linkedin.com/in/suprabhat-supra-06956578/",
  gitHub: "https://github.com/", // point to your username when ready
};
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto">
        ...
        <p className="text-lg leading-relaxed text-gray-700 text-center">
          ...
          high-quality standards in software delivery. Confident about solving real-world
  ...
  <div className="grid md:grid-cols-2 gap-6">
    <Card>
      <CardContent>
        ...
        <ul className="space-y-2 text-gray-700">
          <li>• <span className="font-medium">AWS (Certified)</span> – cloud foundations & deployment exposure.</li>
          <li>• <span className="font-medium">German Language – B1 (in progress)</span>, Goethe-Institut.</li>
        </ul>
      </CardContent>
    </Card>
    <Card>
      <CardContent>
        ...
        <ul className="space-y-2 text-gray-700">
          <li>
  • <span className="font-medium">IQVIA Silver Award</span> — for contributions to COVID-19 vaccine trial analytics.
  {" "}
  <a
    ...
    title="View award proof"
  >
    Click to See <ExternalLink className="h-3 w-3" />
  </a>
</li>
        </ul>
      </CardContent>
...
{/* Thesis & Publications */}
<section className="py-16 px-6 bg-indigo-50">
  <h2 className="text-3xl font-bold mb-8 text-center">Thesis & Publications</h2>
  <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
    <Card>
      <CardContent>
        <h3 className="text-xl font-semibold">Master Thesis – Data Science & Software Development</h3>
        <p className="text-sm text-gray-500">FOXBYTE (CSI Verwaltungs GmbH) • 11/2023 – 09/2024</p>
        <ul className="list-disc list-inside mt-3 text-gray-700">
          <li>Time-series forecasting (LSTM/ARIMA/SARIMAX), anomaly detection, dashboards.</li>
          <li>End-to-end ML pipelines with PyTorch/Keras; focus on deployment & explainability.</li>
        </ul>
        <div className="mt-4">
          <a href={THESIS_LINK} target="_blank" rel="noreferrer">
            <Button className="bg-white">Read Thesis</Button>
          </a>
        </div>
      </CardContent>
    </Card>
    ...
    <Card>
      <CardContent>
        <h3 className="text-xl font-semibold">Selected Write-ups</h3>
        <ul className="list-disc list-inside mt-3 text-gray-700">
          <li>Leveraging AI for Predictive Maintenance (LSTM/ARIMA) – blog insight.</li>
          <li>Building Scalable Full-Stack Apps with React + GraphQL + PostgreSQL.</li>
        </ul>
        <p className="text-sm text-gray-500 mt-3">
          (Hook these to your Medium/GitHub blogs when ready.)
        </p>
      </CardContent>
    </Card>
  </div>
      ...
      <CardContent>
        ...
        <div className="mt-4">
          ...
          <p className="text-sm text-gray-500">
            <a href={LINKS.refMoellerEmail} className="text-indigo-600 hover:underline">
    ...
    <Card>
      <CardContent>
        ...
        <div className="mt-4">
          ...
          <p className="text-sm text-gray-500">
            <a href={LINKS.refHerrmannEmail} className="text-indigo-600 hover:underline">
      ...
      <section className="py-16 px-6 bg-gray-100 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <a href="/Suprabhat_QA_Engineer_CV.pdf" download><Button><Download className="h-4 w-4" /> QA Engineer CV</Button></a>
        </div>
      </section>
